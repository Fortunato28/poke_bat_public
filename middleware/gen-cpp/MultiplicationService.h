...
class MultiplicationServiceIfSingletonFactory : virtual public MultiplicationServiceIfFactory {
 public:
  MultiplicationServiceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<MultiplicationServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<MultiplicationServiceIf> iface_;
};
...
class MultiplicationServiceClient : virtual public MultiplicationServiceIf {
 public:
  MultiplicationServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  MultiplicationServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class MultiplicationServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  MultiplicationServiceProcessor(::apache::thrift::stdcxx::shared_ptr<MultiplicationServiceIf> iface) :
    iface_(iface) {
...
class MultiplicationServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  MultiplicationServiceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< MultiplicationServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< MultiplicationServiceIfFactory > handlerFactory_;
};

class MultiplicationServiceMultiface : virtual public MultiplicationServiceIf {
 public:
  MultiplicationServiceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<MultiplicationServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~MultiplicationServiceMultiface() {}
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<MultiplicationServiceIf> > ifaces_;
  MultiplicationServiceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<MultiplicationServiceIf> iface) {
...
class MultiplicationServiceConcurrentClient : virtual public MultiplicationServiceIf {
 public:
  MultiplicationServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  MultiplicationServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
